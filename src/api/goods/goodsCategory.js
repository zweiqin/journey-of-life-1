...
// 查询类目详情（树结构）
export function categoryReadTree(params) {
	return request({
		url: api.categoryReadTree,
		method: 'GET',
		params
	})
}
...
// 查询类目分级列表（全数据）
export function categoryAllList(params) {
	return request({
