...
export const api = {
  customerCategorySingleStage: '/dtsCustomerCategory/singleStage',
  customerCategoryTree: '/dtsCustomerCategory/categoryTree',
  customerCategorySelectId: '/dtsCustomerCategory/selectId',
  customerCategoryAddCategory: '/dtsCustomerCategory/addCategory',
  customerCategoryUpdateCategory: '/dtsCustomerCategory/updateCategory',
  customerCategoryDelete: '/dtsCustomerCategory/delete'
}
