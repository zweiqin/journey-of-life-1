  ...
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-input
        ...
        placeholder="请输入社区团长名称、号码等" @keyup.enter.native="getList"
      />
      <el-button
    ...
    <TableTools
      ...
      @refresh="getList" @download="toolsMixin_exportMethod($refs.vxeTable, '社区团长')"
    >
    </TableTools>
    ...
    >
      ...
      <template #operate="{ row }">
        <el-button v-permission="[ `GET /admin${api.partnerGetPartnerInfo}` ]" size="mini" @click="$refs.DetailModal && $refs.DetailModal.handleOpen(row, 2)">
          查看
        </el-button>
...
import EditModal from '../communityPartner/components/EditModal'
import DetailModal from '../communityPartner/components/DetailModal'
import DetailModalWC from '../communityPartner/components/DetailModalWC'
