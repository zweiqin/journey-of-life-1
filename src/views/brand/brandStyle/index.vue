<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      />
      <el-button
        v-permission="[ `GET /admin${api.brandStyleList}` ]" size="mini" class="filter-item" type="primary"
    ...
    <TableTools
      ...
      @refresh="getList" @download="toolsMixin_exportMethod($refs.vxeTable, '门店风格')"
    >
      <el-button
        v-permission="[ `POST /admin${api.brandStyleCreate}` ]" size="mini" type="primary" icon="el-icon-plus"
    ...
    <VxeTable
      ...
      :api-path="api.brandStyleList" :columns="columns"
    >
      <template #picUrl="{ row }">
        <el-image
      ...
      <template #operate="{ row }">
        ...
        <el-button
          v-permission="[ `POST /admin${api.brandStyleDelete}` ]" type="danger" size="mini"
