...
import { goodsUpdate, goodsCatAndBrand, goodsProductPlaceList, goodsDetail } from '@/api/goods/goodsList'
...
export default {
  ...
  methods: {
    ...
    async getInfo() {
      ...
      this.multipleSpec = !!(Array.isArray(specifications) && specifications.length)
      this.prev_specifications = JSON.parse(JSON.stringify(specifications))
      this.prev_products = JSON.parse(JSON.stringify(products))
