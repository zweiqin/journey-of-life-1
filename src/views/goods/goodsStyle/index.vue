<template>
  <div class="app-container">
    ...
    <TableTools
      ...
      @refresh="getList" @download="toolsMixin_exportMethod($refs.vxeTable, '商品风格')"
    >
      <el-button
    ...
    <VxeTable
      ...
      :api-path="api.goodsStyleList" :columns="columns"
    >
      <template #operate="{ row }">
        <el-button v-permission="[ `POST /admin${api.goodsStyleUpdate}` ]" size="mini" @click="handleUpdate(row)">
          编辑
        </el-button>
        <el-button
          v-permission="[ `POST /admin${api.goodsStyleDelete}` ]" type="danger" size="mini"
