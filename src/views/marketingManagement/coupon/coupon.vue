  ...
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-input
        ...
        style="width: 200px;"
        placeholder="请输入优惠券标题" @keyup.enter.native="getList"
      />
      <el-select
    ...
    >
      <el-button
        v-permission="[ `POST ${api.couponCreate}` ]" size="mini" type="primary" icon="el-icon-plus"
        @click="handleCreate"
      >
        添加
      </el-button>
    ...
    >
      ...
      <template #operate="{ row }">
        <el-button v-permission="[ `GET ${api.couponRead}` ]" size="mini" @click="handleDetail(row)">
          详情
        </el-button>
        <el-button v-permission="[ `POST ${api.couponUpdate}` ]" type="info" size="mini" @click="handleUpdate(row)">
          编辑
        </el-button>
        <el-button v-permission="[ `POST ${api.couponDelete}` ]" type="danger" size="mini" @click="handleDelete(row)">
          删除
        </el-button>
      </template>
    </VxeTable>
