      ...
      >
        ...
        >
          ...
          <pagination
            ...
            :total="Number(addDataFormListTotal[bindingDataForm.salesmanId + 'a'])"
      ...
      >
        ...
        >
          <el-table
            v-loading="listIdLoading"
            ref="salesman"
            :data="listId[bindingDataForm.salesmanId + 'a']"
            size="small"
            element-loading-text="正在查询中。。。"
            border
            fit
          ...
          <pagination
            ...
            :total="Number(deleteDataFormListTotal[bindingDataForm.salesmanId + 'a'])"
            :page.sync="dataFormListQuery.page"
            :limit.sync="dataFormListQuery.limit"
            @pagination="GetUnbindingStore"
          />
