<template>
	<div class="app-container">
		...
		<div class="filter-container">
			<el-input v-model="listQuery.msgSay" clearable class="filter-item" style="width: 200px;" placeholder="请输入话术" />
			<el-select
				v-model="listQuery.msgSayType" clearable class="filter-item" style="width: 200px;"
				placeholder="请选择话术类型"
			>
