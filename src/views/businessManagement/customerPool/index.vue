  ...
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-input
        ...
        placeholder="请输入客户姓名、电话、职业等" @keyup.enter.native="getList"
      />
      <el-button
        v-permission="[ `GET /admin${api.customerpoolQueryCustomerPoolList}` ]" size="mini" class="filter-item"
    ...
    <TableTools
      ...
      @refresh="getList" @download="toolsMixin_exportMethod($refs.vxeTable, '客户池')"
    >
      <el-button
    ...
    <VxeTable
      ...
      :api-path="api.customerpoolQueryCustomerPoolList" :columns="columns"
    >
      <template #operate="{ row }">
        <el-button v-permission="[ `GET /admin${api.customerpoolSelectByPrimaryKey}` ]" size="mini" @click="handleDetail(row)">
          查看
        </el-button>
        <el-button v-permission="[ `POST /admin${api.customerpoolUpdateByPrimaryKeySelective}` ]" size="mini" @click="handleUpdate(row)">
          编辑
        </el-button>
        <el-button
...
import {
  api,
  customerpoolDeleteByPrimaryKey
