    ...
    >
      ...
      >
        <!-- <el-form-item
          ...
          prop="name"
        >
          <el-input v-model="salesmanDataForm.name" />
        </el-form-item> -->
        <el-form-item
          label="管理员账号"
          prop="username"
...
<script>
import { listAdmin, createAdmin, updateAdmin, deleteAdmin, detailAdmin } from '@/api/business/admin'
