    ...
    >
      <el-table-column type="expand">
        <template slot-scope="scope">
          <el-descriptions
            v-if="scope.row.userUpgradeInfo != ''"
            :column="2"
            title="申请表"
            border
          >
          ...
          <img v-if="scope.row.avatar" :src="scope.row.avatar" width="40" />
            ...
            <!-- 门店 -->
            <el-descriptions-item
              v-if="scope.row.userUpgradeInfo.applicationType == 1"
              label="门店名"
            >
            ...
            >
              <el-image
                ...
                :src="scope.row.userUpgradeInfo.picUrl"
            ...
            >
              <el-image
                ...
                :src="scope.row.userUpgradeInfo.licenseUrl"
                style="width: 100px; height: 100px"
                fit="contain"
              />
            </el-descriptions-item>
            ...
            >
              <el-image
                ...
                :src="scope.row.userUpgradeInfo.brandIdcardProsUrl"
                style="width: 100px; height: 100px"
                fit="contain"
              />
            </el-descriptions-item>
            ...
            >
              <el-image
                ...
                :src="scope.row.userUpgradeInfo.brandIdcardConsUrl"
                style="width: 100px; height: 100px"
                fit="contain"
              />
            </el-descriptions-item>
            ...
            <!-- 业务员信息 -->
            <el-descriptions-item
              v-if="scope.row.userUpgradeInfo.applicationType == 2"
              label="姓名"
            >
            ...
            >
              <el-image
                ...
                :src="scope.row.userUpgradeInfo.idcardProsUrl"
                style="width: 100px; height: 100px"
                fit="contain"
              />
            </el-descriptions-item>
            ...
            >
              <el-image
                ...
                :src="scope.row.userUpgradeInfo.idcardConsUrl"
                style="width: 100px; height: 100px"
                fit="contain"
              />
            </el-descriptions-item>
      ...
      >
        <template slot-scope="scope">
          <el-tag :type="scope.row.status == 0 ? '': scope.row.status == 1? 'success': scope.row.status == -1? 'warning': scope.row.status == 2? 'Danger': 'info'">
            {{
              scope.row.status == 0
                ? '审核中'
                : scope.row.status == 1
...
export default {
  ...
  methods: {
    ...
    // }
    expandchange (item) {
      const StoreType = this.listStoreType.find(
        (p) => p.id === item.userUpgradeInfo.brandgenre
      )
      item.userUpgradeInfo.brandgenreval =
        StoreType === undefined ? '' : StoreType.storeName
    },
    sign (row) {
      if (row.newGrade === 4) {
