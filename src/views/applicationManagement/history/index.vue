      ...
      <el-descriptions :column="2" border>
        ...
        >
          <el-image
            ...
            :src="dialogFormitem.brandIdcardProsUrl"
            fit="contain"
          ></el-image>
        </el-descriptions-item>
        <el-descriptions-item
        ...
        >
          <el-image
            ...
            :src="dialogFormitem.brandIdcardConsUrl"
            fit="contain"
          ></el-image>
        </el-descriptions-item>
        ...
        >
          <el-image
            ...
            :src="dialogFormitem.idcardProsUrl"
            fit="contain"
          ></el-image>
        </el-descriptions-item>
        <el-descriptions-item
        ...
        >
          <el-image
            ...
            :src="dialogFormitem.idcardConsUrl"
            fit="contain"
          ></el-image>
        </el-descriptions-item>
      </el-descriptions>
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      let queryInfo = {};
      let url = '/userup/list?page=' + this.listQuery.page;
    ...
    checking(row) {
      this.dialogFormVisible = true;
      let StoreType=this.listStoreType.find(p=>p.id==row.brandgenre)
