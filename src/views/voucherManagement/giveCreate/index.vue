  ...
  <div class="app-container">
    ...
    <el-card class="box-card">
      ...
      <el-form ref="dataForm" :rules="rules" :model="dataForm" label-width="150px">
        <el-form-item label="赠与方id" prop="holdId">
          <el-input v-model="dataForm.holdId" :disabled="!isAdmin" />
        </el-form-item>
        <el-form-item label="被赠与方id" prop="userId">
    ...
    <div class="op-container">
      ...
      <el-button type="primary" @click="handlePublish">转赠</el-button>
    </div>
  </div>
</template>

<script>
import { circulaCircula } from '@/api/voucherManagement/give'
...
export default {
  ...
  methods: {
    ...
    handleCancel() {
      this.$router.push({ name: 'VoucherManagementGive' })
    },
    handlePublish() {
      this.$refs.dataForm.validate((valid) => {
        if (valid) {
          circulaCircula(this.dataForm)
            .then((response) => {
              this.$notify.success({
