  ...
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-input
        ...
        class="filter-item"
        style="width: 200px;" placeholder="请输入赠与方ID" @keyup.enter.native="getList"
      />
      <el-input
        v-model="listQuery.userId" clearable size="mini" class="filter-item"
        style="width: 200px;"
        placeholder="请输入被赠与方ID" @keyup.enter.native="getList"
      />
      <el-input
        v-model="listQuery.voucherId" clearable size="mini" class="filter-item"
        style="width: 200px;"
        placeholder="请输入代金券ID" @keyup.enter.native="getList"
      />
      <el-button
    ...
    >
      <el-button
        v-permission="[ `GET ${api.circulaList}` ]" size="mini" type="primary" icon="el-icon-plus"
