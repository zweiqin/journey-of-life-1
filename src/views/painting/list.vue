    ...
    >
      ...
      <el-table-column type="expand">
        <template slot-scope="scope">
          ...
          <el-table
            v-loading="listLoading"
            ref="pictures"
            :data="listImg[scope.row.paint_id]"
            size="small"
            element-loading-text="正在查询中。。。"
            border
            fit
            ...
            >
              <template slot-scope="scope">
                ...
                <div
                  ...
                  @click="showPicture(scope.row.img_url)"
                >
                  <img
            ...
            >
              <template slot-scope="scope">
                ...
                <el-button
                  type="danger"
                  size="mini"
                  @click="handleImgDelete(scope.row)"
                >删除</el-button>
              </template>
            </el-table-column>
          </el-table>
      ...
      >
        <template slot-scope="scope">
          ...
          <el-button
            type="primary"
            @click="$refs.painting.toggleRowExpansion(scope.row)"
          >查看</el-button>
        </template>
      </el-table-column>
