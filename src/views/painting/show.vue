    ...
    >
      ...
      >
        <div style="width:95%;height:100%">
          <el-carousel
            :interval="4000"
            :height="300*this.$root.dw+'px'"
            :width="800*$root.dw+'px'"
            type="card"
          >
            <el-carousel-item
