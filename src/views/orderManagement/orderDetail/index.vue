  ...
  <div class="app-container">
    <div class="body-container">
      <el-card>
        ...
        <el-row>
          <el-col :span="12" class="item">
            ...
            <el-image
              :src="userInfo.avatar" style="width: 30px; height: 30px;border-radius:50%;margin-right:8px;"
              fit="contain"
            />
            {{ userInfo.nickname }}
          </el-col>
      ...
      <el-card>
        ...
        <el-table :data="orderGoods" v-bind="$tableCommonOptions">
    ...
    <div class="footer-container">
      ...
      <el-button
        v-if="isShopRole && orderInfo.orderStatus == 101" v-permission="[ `POST /admin${api.orderChangePrice}` ]"
        size="medium" type="warning" @click="handleChangePrice(orderInfo)"
      >
        改价
      </el-button>
      <el-button
        v-if="orderInfo.orderStatus == 201" v-permission="[ `POST /admin${api.orderShip}` ]" size="medium"
        type="success" @click="handleDeliver(orderInfo)"
      >
        发货
      </el-button>
      <el-button
        v-if="orderInfo.orderStatus == 202" v-permission="[ `POST /admin${api.orderRefund}` ]" size="medium"
        type="warning" @click="handleRefund(orderInfo)"
      >
        退款
      </el-button>
      <el-button
