<template>
  <div class="app-container">
    ...
    <!-- 查询结果 -->
    <el-table v-loading="listLoading" ref="salesman" :data="list" size="small" element-loading-text="正在查询中。。。" border fit highlight-current-row>
...
import { idGet, listGet, listDelete } from '@/api/marketing/salesmanManagement'
