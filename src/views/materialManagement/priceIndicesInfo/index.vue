<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      />
      <el-button
        v-permission="['GET /admin/prices/list']"
        size="mini"
        class="filter-item"
        type="primary"
        icon="el-icon-search"
      ...
      >查找</el-button>
      <el-button
        v-permission="['POST /admin/prices/add']"
        size="mini"
        class="filter-item"
        type="primary"
        icon="el-icon-edit"
...
<script>
import { listGet, listDelete, listAdd, listUpdate } from '@/api/materialManagement/priceIndicesInfo'
