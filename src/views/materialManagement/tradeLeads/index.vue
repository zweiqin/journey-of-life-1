<template>
  <div class="app-container">
    ...
    >
      <el-button
        v-permission="[ `POST ${api.tradeLeadsAdd}` ]" size="mini" type="primary" icon="el-icon-plus"
        @click="handleCreate"
      >
        添加
      </el-button>
    ...
    >
      ...
      <template #operate="{ row }">
        <el-button v-permission="[ `POST ${api.tradeLeadsUpdate}` ]" size="mini" @click="handleUpdate(row)">
          编辑
        </el-button>
        <el-button v-permission="[ `POST ${api.tradeLeadsDelete}` ]" type="danger" size="mini" @click="handleDelete(row)">
          删除
        </el-button>
      </template>
    </VxeTable>
