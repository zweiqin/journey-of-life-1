<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-input v-model="listQuery.goodsId" clearable size="mini" class="filter-item" style="width: 200px;" placeholder="请输入商品ID"/>
...
<script>
import { listFootprint } from '@/api/business/user'
