    ...
    <div class="TableContent">
      ...
      <div class="TableContent_tables">
        ...
        <div id="salesChart" class="tables_left">
          ...
          <!-- 双折线图 -->
          <DoubleLineChart text="社区数量" :value="brandSum" unit="家"></DoubleLineChart>
          <!-- 柱状图 -->
          <BarChart text="社区收入额" :value="brandTurnover"></BarChart>
          <!-- 横向柱状图 -->
          <HorizontalBarChartMap text="社区收益额前三" :value="branList"></HorizontalBarChartMap>
          <!-- 雷达图 -->
...
<script>
import { api, queryCommunityReportForms } from '@/api/financialCenter'
// 表头按钮的组件
