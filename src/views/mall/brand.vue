		...
		>
			...
			<el-table-column align="center" label="操作" min-width="200" class-name="small-padding fixed-width">
				<template slot-scope="scope">
					...
					<el-button
						v-permission="[ 'POST /admin/brand/update' ]" size="mini"
		...
		<el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
			...
			>
				...
				<el-form-item label="门店类型" prop="brandgenre">
					<el-select v-model="dataForm.brandgenre" filterable placeholder="请选择门店类型">
						<el-option v-for="item in TypeOptions" :key="item.id" :label="item.storeName" :value="item.id" />
					</el-select>
