    ...
    <div style="height: 680px; overflow-y: auto; overflow-x: hidden">
      <div class="carousel-wrapper">
        <div class="" style="height: 100%; width: 100%">
          <el-carousel
            v-if="formData.gallery && formData.gallery.length"
            trigger="click"
            height="390px"
          >
            <el-carousel-item v-for="item in formData.gallery" :key="item.uid">
              <div class="carousel-wrapper-images">
                <el-image :src="item.resData || item" fit="contain"></el-image>
              </div>
            </el-carousel-item>
          </el-carousel>
          <el-image
      ...
      <div class="goods-info">
        <div class="detail-price">
          ￥<span>{{ formData.counterPrice || 8888 }}</span
          >起
        </div>
